<nav class="top-0 z-50 fixed w-full pb-4 pt-5  bg-cuspat-blue border-gray-200">
   <div class=" w-full flex items-center justify-between">
     <div class="flex justify-between items-center w-full">
      ...
      {{-- menu navbar --}}
      <div class="hidden mt-4 md:absolute md:ml-32 sm:flex min-[768px]:gap-5 min-[930px]:gap-10 gap-7 lg:gap-10 xl:gap-16 xl:text-lg text-sm font-semibold text-white font-Lato">
        <a href="">Beranda</a>
        <a href="">Produk</a>
      ...
      <div id="defaultModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto mt-20 max-h-full">
        ...
        <form class="hidden lg:flex">   
           ...
           <div class="hidden md:flex items-center gap-[20px]">
            <a href="">
              <iconify-icon class="text-white" icon="fa6-solid:basket-shopping" width="24" height="24"></iconify-icon>
            </a>
        ...
        <div class="relative z-50 bg-white rounded-lg shadow">
            ...
            <div class="p-8">
              <img src="{{ asset('asset/logo-cuspat/logo-kuning-cuspat.png') }}" class=" mx-auto w-24 h-24" alt="logo cuspat">
                ...
                <form class="space-y-6 mt-5 mx-5" action="#">
                    <div>
                            ...
                            <form class="space-y-6 mt-5  w-full" action="#">
                                ...
                                <div class="flex items-center ">
                                  <label for="email" class="block w-1/2 mb-2 text-sm font-bold font-Lato text-cuspat-blue">Email</label>
                                    {{-- name diisi sesuai atribut dari table user --}}
                                  <input type="email" name="#" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg placeholder:text-gray-400 focus:ring-cuspat-blue focus:border-cuspat-blue block w-full p-2.5 "placeholder="Masukkan Email" required>
                              </div>
                              <div class="flex items-center">
                                ...
                                <div class="relative flex items-center" x-data="{ show: true }">
                                  <label for="password" class="block w-1/2  mb-2 text-sm font-bold font-Lato text-cuspat-blue">Konfirmasi Kata Sandi</label>
                                  <iconify-icon icon="mdi:hide" @click="show = !show"
                                  :class="{'hidden': !show, 'block':show }" class="absolute cursor-pointer right-4 bottom-2 text-cuspat-blue" widht="24" height="24"></iconify-icon>
                                  <iconify-icon icon="mdi:eye" @click="show = !show"
                                  :class="{'block': !show, 'hidden':show }" class="absolute cursor-pointer right-4 bottom-2 text-cuspat-blue" widht="24" height="24"></iconify-icon>
                                  <input type="password" :type="show ? 'password' : 'text'" name="password" id="password" placeholder="Masukkan Konfirmasi Kata Sandi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cuspat-blue focus:border-cuspat-blue block w-full p-2.5" required>
                              </div>
                            </form>
